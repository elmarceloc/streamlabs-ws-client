    ...
    handleEvent(event) {
        ...
        switch (event.type) {
            case "follow": {
                ...
                this.emit("follow", Object.assign({}, event.message, { platform: "twitch", isTest }));
                break;
            }
            case "subscription": {
                ...
                if (isReSub) {
                    this.emit("resubscription", Object.assign({}, event.message, { platform: "twitch", months,
                        isTest }));
                }
                else {
                    this.emit("subscription", Object.assign({}, event.message, { platform: "twitch", months,
                        isTest }));
                }
                break;
            }
            case "donation": {
                ...
                this.emit("donation", Object.assign({}, event.message, { platform: "streamlabs", amount,
                    isTest }));
                break;
            }
            case "host": {
                ...
                this.emit("host", Object.assign({}, event.message, { platform: "twitch", viewers,
                    isTest }));
                break;
            }
            case "bits": {
                ...
                // Ensure viewers is of type number
                const amount = Number(helpers_1.removeNonNumeric(event.message.amount));
                this.emit("bits", Object.assign({}, event.message, { platform: "twitch", amount,
                    isTest }));
                break;
            }
            case "raid": {
                ...
                this.emit("raid", Object.assign({}, event.message, { platform: "twitch", raiders,
                    isTest }));
                break;
            }
            case "merch": {
                ...
                this.emit("merch", Object.assign({}, event.message, { platform: "twitch", isTest }));
                break;
            }
            default: {
                // Unknown event type
                this.emit(event.type, Object.assign({}, event.message, { isTest }));
                break;
            }
        }
    }
